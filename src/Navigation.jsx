...
//              </a>
//               <a
//                 href="/Countact Us" target="_blank"
//                 class="text-black text-[20px] no-underline px-5 font-poppins text-base hover:text-sky-300"
//               >
//                 Contact Us
//              </a>
    ...
    <nav className="m-0 p-0 box-border">
      ...
      <div className="bg-[#183d3d] text-white flex justify-between items-center p-2.5">
        <div className="flex items-center gap-5">
          <Link
            to="/register"
            className="text-white font-poppins text-xl p-2.5 no-underline hover:text-sky-300"
          >
            Login/Register
          </Link>
          <Link
      ...
      <div className="bg-white flex items-center justify-center font-poppins text-base p-2.5">
        <div className="flex items-center gap-5">
          <Link
            to="/Home"
            className="text-black text-[20px] no-underline px-5 font-poppins hover:text-sky-300"
          >
            Home
          </Link>
          <Link
